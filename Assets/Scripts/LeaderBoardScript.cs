...
public class LeaderBoardScript : MonoBehaviour
{
    ...
    IEnumerator GetLeaderboards()
    {
        ...
        string uri = "https://factualchicken.backendless.app/api/services/IEyeLeaderboards/getDiseaseLeaderboards";
    ...
    IEnumerator PostScore()
    {
        ...
        string uri = "https://factualchicken.backendless.app/api/services/IEyeLeaderboards/postDiseaseScore";
